...
object pepita {
	...
	method move(nuevaPosicion) {
		// TODO 10 está harcodeado! acá tenes que usar el puedoVolar(distancia) 
		// que me parece que no estas usando en ningún lado !
		if (energia > 10) {
	...
	method teEncontro(alguien) {
		...
		// TODO me parece que si está hecho :P o falta algo?
